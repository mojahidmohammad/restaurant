...
import 'package:restaurant/Authorization/numeric_pad.dart';
...
class _VerifyPhoneState extends State<VerifyPhone> {
  AuthController authenticationAPI = Get.put(AuthController());
  String code = "";
@override
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            var res = await authenticationAPI.Login(phoneNumber:widget.phoneNumber,OTP: code.toString() );
                            print(res);
                            if(code.length == 4) {
                              if (res) {
                                Navigator.push(
